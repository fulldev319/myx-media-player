...
import {apiGetFollowers, apiGetFollowings} from 'helper/userHelpers';
import {RootState} from 'redux/interfaces';
import {useSelector} from 'react-redux';
import {useNavigation} from '@react-navigation/native';
import {apiGetCountryDetail} from 'helper/mapHelper';

export const FollowingSheet = ({show, onClose}) => {
  ...
  const renderHeader = () => {
    return (
      <View style={styles.header}>
        ...
        <Text style={styles.title}>{`Followings (${totalUsers})`}</Text>
      </View>
    );
  };
